<template>
  <section
    class="relative w-full h-[110vh] bg-cover bg-center flex items-center px-8 sm:px-16 md:px-24 text-white"
  ...
  >
    ...
    <div class="relative z-10 max-w-2xl">
      ...
      <h1 class="text-2xl sm:text-3xl font-extrabold mb-4 drop-shadow-lg">
