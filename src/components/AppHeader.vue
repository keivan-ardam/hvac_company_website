<template>
  <div class="w-full p-2 lg:hidden">
    <button
      class="w-full bg-blue-800 px-1 py-2 rounded-sm text-white text-transform: uppercase font-bold font-mono"
    >
      Schedule Now
    </button>
  </div>
  <header
    class="w-full lg:w-[85vw] flex flex-col-reverse lg:flex-row justify-between lg:items-center p-1 sticky top-0 lg:fixed lg:top-10 lg:left-1/2 transform lg:-translate-x-1/2 z-50 bg-white lg:shadow-md lg:border lg:rounded-lg"
  >
    <nav>
      <ul
    ...
    <button
      class="hidden lg:block mx-4 bg-blue-800 px-6 py-2 rounded-lg text-white text-transform: uppercase font-bold font-mono"
    >
      Schedule Now
    </button>
  </header>
